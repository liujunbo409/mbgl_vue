<template>
  <div >
      <div id="zgzj_container">
                        <img id="zgzj_img" class="aui-margin-l-15"
...
<script>
import qiniu from '../assets/js/qiniu.min'
  export default {
    data(){
      return {
        title: '按钮样式',
    ...
    methods :{
        upload : function(){
            ...
            this.common.consoledebug.log(res.data.ret);
            ...
            qiniu.upload({
                ...
                browse_button: "zgzj_img",         // 上传选择的点选按钮，必需
                container: "zgzj_container",//上传按钮的上级元素ID
                ...
                drop_element: "zgzj_container",          // 拖曳上传区域元素的ID，拖曳文件或文件夹后可触发上传
...
//                     }
                        FileUploaded(up, file, info) {
                            ...
                            this.uploadurl.push(sourceLink);
